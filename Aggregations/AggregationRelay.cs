// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AggregationRelay.cs" company="DigitalGlobe">
...
namespace Aggregations
{
    ...
    /// The GBD relay.
    /// </summary>
    public class AggregationRelay
    {
        /// <summary>
        /// The instance.
        /// </summary>
        private static AggregationRelay instance;
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="AggregationRelay"/> class from being created.
        /// </summary>
        private AggregationRelay()
        {
        }
        ...
        /// Gets the instance.
        /// </summary>
        public static AggregationRelay Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new AggregationRelay();
                }
